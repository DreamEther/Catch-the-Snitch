...
public class Orb5 : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        do
        {
            ...
            InvokeRepeating("RandomTimeBeforeColorChange5", 0, 0);
            ...
            InvokeRepeating("RandomColorIndex5", 0, 0);
    ...
    IEnumerator ChangeColor()
    {
        ...
        GetComponent<SpriteRenderer>().material.color = selectColor.GetColor(RandomColorIndex5());
        GetComponentInChildren<Image>().color = GetComponent<SpriteRenderer>().material.color;
        for (int i = 0; i < orbLightning.Length; i++)
        {
            var orbLightningColor = orbLightning[i].GetComponent<SpriteRenderer>();
        ...
        yield return new WaitForSecondsRealtime(RandomTimeBeforeColorChange5());
    ...
    private int RandomTimeBeforeColorChange5()
    {
    ...
    private string RandomColorIndex5()
    {
